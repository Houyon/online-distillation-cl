...
This file is part of the on-the-fly domain adaptation software.
...
class TinyNet(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        self.pyr_AveragePool1 = nn.AvgPool2d(kernel_size=(135,240), stride=(135,240)) #(1,1)
        self.pyr_upsample1 = nn.Upsample(scale_factor=(135,240))

        self.pyr_AveragePool2 = nn.AvgPool2d(kernel_size=(45,120), stride=(45,120)) # (3,2)
        ...
        self.pyr_AveragePool3 = nn.AvgPool2d(kernel_size=(27,60), stride=(27,60)) # (5,4)
        self.pyr_conv3 = nn.Conv2d(in_channels=64, out_channels=64, kernel_size=(3,3),stride=(1,1), padding=(1,1)) 
        self.pyr_upsample3 = nn.Upsample(scale_factor=(27,60))

        self.pyr_AveragePool4 = nn.AvgPool2d(kernel_size=(15,30), stride=(15,30)) # (9,8)
